...
export const metadata: Metadata = {
  ...
  description:
    "Join our ambassador program and help preserve languages in your community. Make a difference by connecting technology with cultural heritage.",
  keywords:
    "language ambassador, cultural preservation, community leader, language technology",
};
  ...
  return (
    <Layout>
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Become a Wekify Language Ambassador
              </h1>
              <p className="text-xl md:text-2xl mb-8">
                Join our global network of passionate advocates preserving
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gray-700">
                Wekify Ambassadors play a crucial role in bridging technology
                with cultural preservation. As an ambassador, you'll help
                communities document, learn, and celebrate their indigenous
                languages.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="bg-gray-50 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700">
                  Help bring Wekify's language preservation tools to your
                  community and beyond, reaching more indigenous language
                  speakers.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700">
                  Organize workshops, events, and initiatives that bring
                  together language enthusiasts and native speakers.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700">
                  Receive official certification, exclusive networking
                  opportunities, and recognition for your cultural preservation
                  work.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <div className="order-2 md:order-1">
                  ...
                  <p className="text-xl text-gray-700 mb-6">
                    Our ambassadors span across continents, united by a shared
                    passion for language preservation and cultural heritage.
                    When you become an ambassador, you're joining a supportive
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gray-700">
                Wekify values your contribution and offers exclusive benefits to
                our ambassadors.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Receive official recognition as a Wekify Language Ambassador with digital and physical credentials.",
                },
                {
                  icon: <Heart className="h-8 w-8 text-indigo-600" />,
                  title: "Early Access",
                  description:
                    "Be the first to access new Wekify features, tools, and language resources.",
                },
                {
                  icon: <Users className="h-8 w-8 text-indigo-600" />,
                  title: "Exclusive Network",
                  description:
                    "Connect with other ambassadors, language experts, and the Wekify team.",
                },
                {
                  icon: <Clock className="h-8 w-8 text-indigo-600" />,
                  title: "Professional Development",
                  description:
                    "Access training, workshops, and resources to enhance your skills.",
                },
              ].map((benefit, i) => (
                <div
                  key={i}
        ...
        <section
          id="apply"
          className="py-20 bg-gradient-to-r from-indigo-900 to-blue-900 text-white"
        >
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl opacity-90 max-w-2xl mx-auto">
                  Ready to make a difference in language preservation? We're
                  looking for passionate advocates to join our global network.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-700">
                  Have questions about becoming a Wekify Ambassador? Find
                  answers below.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    answer:
                      "Ambassadors promote language preservation in their communities, organize events, provide feedback on Wekify products, and contribute to our global network of language advocates.",
                  },
                  {
                    question: "Is this a paid position?",
                    answer:
                      "The ambassador program is primarily volunteer-based, focused on making a positive impact in language preservation. However, ambassadors receive exclusive benefits, networking opportunities, and professional development resources.",
                  },
                  {
                    question: "How much time commitment is required?",
                    answer:
                      "The program is flexible and can be adapted to your availability. We recommend dedicating at least 5-10 hours monthly to ambassador activities.",
                  },
                  {
                    question:
                      "Can I apply if my language isn't currently supported by Wekify?",
                    answer:
                      "Absolutely! We're especially interested in expanding to new languages. Your insights would be valuable in helping us develop resources for additional languages.",
                  },
                  {
                    question: "What is the application process like?",
                    answer:
                      "After submitting your application, our team will review it and contact qualified candidates for a video interview. Selected ambassadors receive an onboarding package and join our next cohort.",
                  },
                ].map((faq, i) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                Join our ambassador program today and help bridge technology
