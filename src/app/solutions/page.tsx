...
export const metadata: Metadata = {
  ...
  description:
    "Digital solutions for language preservation and cultural revitalization",
  keywords: [
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're a technology company pushing boundaries in software
              development, AI, and digital transformation. While we're proud of
              our language preservation work, our expertise spans multiple
              domains.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Enterprise-grade solutions, web applications, and specialized
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Cross-platform mobile applications with cutting-edge features
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Big data processing, analytics, and intelligent database
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Scalable cloud solutions, DevOps services, and infrastructure
                optimization.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Innovative solutions for language preservation and digital
                transformation of linguistic resources.
              </p>
            </div>
          </div>
          ...
          <div className="mt-24 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12">
              We're constantly exploring new technological frontiers through our
              R&D initiatives:
            </p>
