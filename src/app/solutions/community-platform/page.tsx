          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="p-6 bg-white rounded-xl border border-neutral-100 hover:border-neutral-200 transition-colors">
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-6 bg-white rounded-xl border border-neutral-100">
                <h3 className="text-xl font-semibold mb-4 text-neutral-900">For Language Communities</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-primary-600 mt-1" />
                    <span className="text-neutral-600">Empowerment through digital tools and resources</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-primary-600 mt-1" />
                    <span className="text-neutral-600">Preservation of cultural knowledge and traditions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-primary-600 mt-1" />
                    <span className="text-neutral-600">Strengthened community bonds and collaboration</span>
                  </li>
                </ul>
              </div>
              <div className="p-6 bg-white rounded-xl border border-neutral-100">
                <h3 className="text-xl font-semibold mb-4 text-neutral-900">For Language Preservation</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-primary-600 mt-1" />
                    <span className="text-neutral-600">Systematic documentation of language materials</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-primary-600 mt-1" />
                    <span className="text-neutral-600">Intergenerational knowledge transfer</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-primary-600 mt-1" />
                    <span className="text-neutral-600">Sustainable language revitalization</span>
                  </li>
                </ul>
              </div>
            </div>
