                ...
                <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="group relative">
                      <Info className="h-4 w-4 md:h-5 md:w-5 text-gray-400 cursor-pointer hover:text-blue-600" />
                      <div className="absolute left-1/2 -translate-x-1/2 -top-2 w-48 md:w-64 bg-white p-3 md:p-4 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 invisible group-hover:visible">
