          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-indigo-700/70 max-w-3xl mx-auto">
                Evaluate your language preservation needs with our comprehensive assessment tools.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Assess the vitality of your language based on UNESCO's framework for language endangerment."
                },
                {
                  icon: <Users className="h-10 w-10 text-indigo-600" />,
                  title: "Speaker Demographics",
                  description: "Analyze speaker population, age distribution, and intergenerational transmission patterns."
                },
                {
                  icon: <BookOpen className="h-10 w-10 text-indigo-600" />,
                  title: "Resource Inventory",
                  description: "Identify existing documentation, educational materials, and digital resources for your language."
                },
                {
                  icon: <Zap className="h-10 w-10 text-indigo-600" />,
                  title: "Custom Roadmap",
                  description: "Receive a tailored preservation strategy based on your assessment results."
                }
              ].map((feature, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-indigo-100">
                  <div className="bg-indigo-100 p-4 rounded-full inline-block mb-6">
                    {feature.icon}
                  </div>
                  <h3 className="text-xl font-semibold mb-4 text-indigo-800">{feature.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="p-8 rounded-xl bg-white shadow-lg border border-slate-200">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold ml-4 text-slate-800">Global Language Directory</h3>
                </div>
              ...
              <div className="relative rounded-xl overflow-hidden h-[400px] shadow-lg">
                <Image 
                  ...
                  alt="Global language communities" 
                  fill
                ...
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="text-2xl font-bold text-white mb-2">Join Our Ambassador Program</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <p className="text-blue-100">Empowering communities to lead their own language preservation efforts</p>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-300 rounded-full mr-3 mt-2"></span>
                    <p className="text-blue-100">Making language technology accessible to all communities regardless of resources</p>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-300 rounded-full mr-3 mt-2"></span>
                    <p className="text-blue-100">Creating sustainable models for ongoing language development</p>
                  </li>
                </ul>
                <Link 
                  href="/about/vision" 
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-300 rounded-full mr-3 mt-2"></span>
                    <p className="text-blue-100">Community-driven development that centers indigenous priorities</p>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-300 rounded-full mr-3 mt-2"></span>
                    <p className="text-blue-100">Data sovereignty ensuring communities retain ownership of their language data</p>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-300 rounded-full mr-3 mt-2"></span>
                    <p className="text-blue-100">Privacy-first approach to technology development</p>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-300 rounded-full mr-3 mt-2"></span>
                    <p className="text-blue-100">Transparent and accountable partnership models</p>
                  </li>
                </ul>
                <Link 
