...
export default function CompanyPage() {
  return (
    <Layout>
      <Head>
        <title>Wekify - Our locations</title>
        <meta
          name="description"
          content="Wekify is a global company with offices in multiple locations. Find out where we're located and how you can join our team."
        />
        <meta
          name="keywords"
